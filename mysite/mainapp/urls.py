...
urlpatterns = [
	...
	url(r'^kallori/cereals_kll$', views.cereals_page, name='cereals_kll'),
	url(r'^kallori/milk_kll$', views.milk_page, name='milk_kll'),
	...
	url(r'^kall_reg/cereals_for_reg$', views.cerealsForReg_page, name='cereals_for_reg'),
	url(r'^kall_reg/milk_for_reg$', views.milkForReg_page, name='milk_for_reg'),
